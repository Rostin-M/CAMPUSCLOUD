(() => {
  ...
  const emailRegex = /^[a-zA-Z0-9._%+-]+@(soyudemedellin\.edu\.co|udemedellin\.edu\.co)$/; // Pendiente la de admin(Implicita)
  ...
  function validateEmail() {
    ...
    if (
      ...
      showTooltip(emailErr, 'El dominio debe ser @soyudemedellin.edu.co o @udemedellin.edu.co.');
      return false;
    }

    if (!emailRegex.test(emailVal)) {
      showTooltip(emailErr, 'Formato incorrecto. Usa @soyudemedellin.edu.co o @udemedellin.edu.co.');
      return false;
    }
